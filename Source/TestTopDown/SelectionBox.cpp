...
bool ASelectionBox::IsCenterInBox(FVector ActorLocation)
{
	const FVector LocalActorCenter = BoxCollider->GetComponentTransform().InverseTransformPosition(ActorLocation);
